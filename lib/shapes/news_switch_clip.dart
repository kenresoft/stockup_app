...
class NewsSwitchClip extends CustomPainter {
  const NewsSwitchClip({required this.currentIndex});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.arcToPoint(Offset(20.w, 0), radius: const Radius.circular(25).r);
